...
const PLACEHOLDER = "Оберіть вік вашої дитини";
        ...
        return (
          <div ref={rootRef} className="age-select">
            ...
            <div className="relative">
              ...
              >
                <span
                  className={`age-select__value${hasValue ? "" : " is-placeholder"}`}
                >
                  {hasValue ? formatAgeLabel(field.value as number) : PLACEHOLDER}
                </span>
                <svg
              ...
              {open && (
                <ul
                  ...
                  aria-activedescendant={
                    hasValue ? `${listId}-opt-${field.value}` : undefined
                  }
                >
                  {AGES.map((age) => {
